        ...
        <div className="container">
          <div className="footer-content">
            <div className="footer-section footer-brand">
              <div className="footer-logo-container">
                ...
                <div className="footer-logo-fallback" style={{display: 'none'}}>
                  <h2 style={{color: '#d4af37', fontSize: '2.5rem', fontFamily: 'Oswald', margin: 0}}>ESTUDIOS PANDA</h2>
                </div>
              </div>
              <p>
            ...
            <div className="footer-section footer-contact">
              <h3>Contacto</h3>
              <p><span>📍</span> Av. Segurola 1289, Buenos Aires</p>
              <p><span>📞</span> +54 011 6221 8021</p>
              <p><span>✉️</span> info@estudiospanda.com.ar</p>
              <p><span>📷</span> @estudiospanda</p>
              <p><span>🕒</span> Servicios 24hs</p>
            </div>
            ...
            <div className="footer-section footer-form">
              ...
              <form className="footer-contact-form">
                ...
                <textarea placeholder="Contanos sobre tu proyecto" rows="3" required></textarea>
          ...
          <div className="footer-bottom">
            <p>&copy; 2025 Estudios Panda. Todos los derechos reservados.</p>
            <p>Grabado, mezclado y masterizado en Estudios Panda</p>
            <div className="footer-awards">
              <div className="award-item">
                <span className="award-icon">🏆</span>
                <span>Grammy Latino</span>
              </div>
              <div className="award-item">
                <span className="award-icon">🏆</span>
                <span>Billboard Awards</span>
              </div>
              <div className="award-item">
                <span className="award-icon">🏆</span>
                <span>Premios Gardel</span>
              </div>
              <div className="award-item">
                <span className="award-icon">🏆</span>
